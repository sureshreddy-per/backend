import { Get, Post, Put, Delete, Body, Param, Query, NotFoundException } from '@nestjs/common';
...
export class BaseController<T extends { id: string }> {
  ...
  @Get()
  async findAll(@Query() query: PaginationQueryDto): Promise<PaginatedResponse<T>> {
