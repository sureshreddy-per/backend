...
// Using const object instead of enum for type safety in TypeScript
export const EventMetricType = {
  // User metrics
...
export type EventMetricType = typeof EventMetricType[keyof typeof EventMetricType];
