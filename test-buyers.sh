...
BUYER_RESPONSE=$(make_request "POST" "/buyers/profile" "$BUYER_TOKEN" '{
...
# Test 5: Get buyer details
print_test_header "Get Buyer Details"
make_request "GET" "/buyers/details" "$BUYER_TOKEN"

# Test 6: Update buyer preferences
print_test_header "Update Buyer Preferences"
make_request "PUT" "/buyers/preferences" "$BUYER_TOKEN" '{
    "min_price": 40,
    "max_price": 60,
